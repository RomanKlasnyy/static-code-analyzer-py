...
class PepAnalyzer(ast.NodeVisitor):
    ...
    def get_params(self, lineno: int) -> list:
        return self.stats["parameters"][lineno]

    def get_vars(self, lineno: int) -> list:
        return self.stats["variables"][lineno]

    def get_mutable_def(self, lineno: int) -> str:
...
def path_analyzer(pathname: str):
